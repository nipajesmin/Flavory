      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-6">
          ...
          <p className="text-sm md:text-base mt-2">
            Serving delicious meals from around the world—one bite at a time.
          </p>
        </div>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center border-t border-gray-700 pt-6">
          ...
          <div className="text-center md:text-left mb-6 md:mb-0">
            ...
            <p className="text-sm mt-2">Email: support@flavory.com</p>
        ...
        <div className="text-center mt-6 text-sm border-t border-gray-700 pt-4">
          <p>© {new Date().getFullYear()} Flavory. All Rights Reserved.</p>
        </div>
      </div>
    </footer>
  );
